<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
    ...
    <ul class="flex flex-col py-4 px-4 overflow-y-auto gap-1 flex-grow">
        ...
        <!-- Dashboard -->
        <li>
            <a href="{{ route('admin.dashboard') }}" class="flex items-center justify-between px-4 py-2.5 rounded-[0.375rem] {{ request()->routeIs('admin.dashboard') ? 'bg-primary/10 text-primary font-medium' : 'text-body dark:text-dark-body hover:bg-primary/5 hover:text-primary dark:hover:bg-dark-border/30' }} transition-colors group">
                <div class="flex items-center gap-3">
                    <span class="material-symbols-outlined text-[20px] {{ request()->routeIs('admin.dashboard') ? '' : 'text-muted dark:text-dark-muted group-hover:text-primary' }} transition-colors" {{ request()->routeIs('admin.dashboard') ? 'style=font-variation-settings:\'FILL\'1;' : '' }}>home</span>
        ...
        <!-- Petani -->
        <li>
            <a href="{{ route('admin.petani.index') }}" class="flex items-center justify-between px-4 py-2.5 rounded-[0.375rem] {{ request()->routeIs('admin.petani*') ? 'bg-primary/10 text-primary font-medium' : 'text-body dark:text-dark-body hover:bg-primary/5 hover:text-primary dark:hover:bg-dark-border/30' }} transition-colors group">
                <div class="flex items-center gap-3">
                    <span class="material-symbols-outlined text-[20px] {{ request()->routeIs('admin.petani*') ? '' : 'text-muted dark:text-dark-muted group-hover:text-primary' }} transition-colors" {{ request()->routeIs('admin.petani*') ? 'style=font-variation-settings:\'FILL\'1;' : '' }}>group</span>
        ...
        <li class="px-4 mt-6 mb-2">
            <span class="text-[11px] font-medium uppercase text-muted dark:text-dark-muted tracking-widest relative before:content-[''] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-2 before:h-[1px] before:bg-muted dark:before:bg-dark-muted ml-3">Manajemen</span>
        </li>

        <!-- Kunjungan -->
        <li>
            <a href="{{ route('admin.kunjungan') }}" class="flex items-center justify-between px-4 py-2.5 rounded-[0.375rem] {{ request()->routeIs('admin.kunjungan*') ? 'bg-primary/10 text-primary font-medium' : 'text-body dark:text-dark-body hover:bg-primary/5 hover:text-primary dark:hover:bg-dark-border/30' }} transition-colors group">
                <div class="flex items-center gap-3">
        ...
        <!-- Petugas -->
        <li>
            <a href="{{ route('admin.petugas.index') }}" class="flex items-center justify-between px-4 py-2.5 rounded-[0.375rem] {{ request()->routeIs('admin.petugas*') ? 'bg-primary/10 text-primary font-medium' : 'text-body dark:text-dark-body hover:bg-primary/5 hover:text-primary dark:hover:bg-dark-border/30' }} transition-colors group">
                <div class="flex items-center gap-3">
                    <span class="material-symbols-outlined text-[20px] text-muted dark:text-dark-muted group-hover:text-primary transition-colors">badge</span>
